...
class CropState extends State<Crop2> with TickerProviderStateMixin, Drag {
  ...
  @override
  void didUpdateWidget(Crop2 oldWidget) {
...
class _CropPainter extends CustomPainter {
  ...
  void _drawHandles(Canvas canvas, Rect boundaries) {
    print("_drawHandles new area: $area");
